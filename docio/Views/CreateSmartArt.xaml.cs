...
namespace syncfusion.dociodemos.wpf
{
    ...
    /// </summary>
    public partial class CreateSmartArt : DemoControl
    {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                document.Open(dataPath + "CreateSmartArtInput.docx", FormatType.Docx);
                ...
                switch (comboBox1.SelectedIndex)
                {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        // Create a Picture SmartArt diagram. Pass basePath to load images.
                ...
                catch (Exception ex)
                {
                    if (ex is IOException)
                        MessageBox.Show("Please close the file (" + Directory.GetCurrentDirectory() + filename + ") then try generating the document.", "File is already open",
        ...
        /// </summary>
        /// <param name="document">The Word document where the SmartArt diagram will be added.</param>
        /// <param name="dataPath">The path to the folder containing images.</param>
        private void CreatePictureSmartArt(WordDocument document)
        {
            ...
            AddPicture(employeeNode1, "Nancy Davolio.png");
            ...
            AddPicture(employeeNode2, "Andrew Fuller.png");
            ...
            AddPicture(employeeNode3, "Janet Leverling.png");
        }
        ...
        private void AddPicture(IOfficeSmartArtNode node, string imageName)
        {
            // Load the image and assign it to the SmartArt node
            Stream pictureStream = GetFileStream(imageName);
        ...
        {
            Assembly assembly = typeof(CreateSmartArt).Assembly;
