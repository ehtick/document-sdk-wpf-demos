                    ...
                    if (File.Exists(fullPath))
                    {
                        ...
                        using (WordDocument wordDoc = new WordDocument(fullPath))
                        {
                            try
                            {
                                ...
                                converter.Settings.EmbedFonts = checkBox2.IsChecked.Value;
                                converter.Settings.PreserveFormFields = checkBox3.IsChecked.Value;
                                converter.Settings.ExportBookmarks = checkBox4.IsChecked.Value
