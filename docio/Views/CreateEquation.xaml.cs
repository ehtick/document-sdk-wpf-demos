...
namespace syncfusion.dociodemos.wpf
{
    ...
    /// </summary>
    public partial class CreateEquation : DemoControl
    {
        # region Constructor
        /// <summary>
        /// Window constructor
            ...
            try
            {
                ...
                using (WordDocument document = new WordDocument())
                {
                    ...
                    if (worddocx.IsChecked.Value)
                    {
                        ...
                        catch (Exception ex)
                        {
                            if (ex is IOException)
                                MessageBox.Show("Please close the file (" + Directory.GetCurrentDirectory() + "\\Create Equation.docx" + ") then try generating the document.", "File is already open",
                    ...
                    else if (pdf.IsChecked.Value)
                    {
                        ...
                        {
                            if (ex is IOException)
                                MessageBox.Show("Please close the file (" + Directory.GetCurrentDirectory() + "\\Create Equation.pdf" + ") then try generating the document.", "File is already open",
                                     MessageBoxButton.OK, MessageBoxImage.Error);
                            else
                                MessageBox.Show("Document could not be generated, Could you please email the error details to support@syncfusion.com for trouble shooting" + "\r\n" + ex.ToString(), "Error",
                                        MessageBoxButton.OK, MessageBoxImage.Error);
