    ...
    public class DocIOProductDemos : ProductDemo
    {
        public DocIOProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo()
            {
                ...
                DemoViewType = typeof(CreateUsingLaTeX)
            });
            this.Demos.Add(new DemoInfo()
            {
                SampleName = "Edit using LaTeX",
                GroupName = "MATHEMATICAL EQUATION",
                ...
                DemoViewType = typeof(EditUsingLaTeX)
            });
            this.Demos.Add(new DemoInfo()
            {
		...
		DemoViewType = typeof(WordToPDFUA)
			...
			this.Demos.Add(new DemoInfo()
            {
                SampleName = "Create Ink",
                GroupName = "INK",
                Tag = Tag.New,
                Description = "This sample demonstrates how to create a Word document with Ink using .NET Word Library (DocIO).",
                DemoViewType = typeof(CreateInk)
            });
			this.Demos.Add(new DemoInfo()
            {
                SampleName = "Edit Ink",
                GroupName = "INK",
                Tag = Tag.New,
                Description = "This sample demonstrates how to modify Ink in a Word document using .NET Word Library (DocIO).",
                DemoViewType = typeof(EditInk)
            });
            this.Demos.Add(new DemoInfo()
            {
