...
namespace syncfusion.invoice.wpf
{
    ...
    class ExportWord
    {
        ...
        public void CreateWord(IList<InvoiceItem> invoiceItems, BillingInformation billInfo, double totalDue)
        {
            ...
            Stream inputStream = assembly.GetManifestResourceStream("syncfusion.invoice.wpf.Assets.Template.docx");
            //Create instance
                 ...
                 MessageBoxButton.YesNo, MessageBoxImage.Information) == MessageBoxResult.Yes)
            {
                ...
                process.StartInfo = new System.Diagnostics.ProcessStartInfo("Invoice.docx") { UseShellExecute = true };
                process.Start();
            }
            //Close instance
            document.Close();
