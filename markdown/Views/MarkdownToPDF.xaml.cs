...
namespace syncfusion.markdowndemos.wpf
{
    ...
    /// </summary>
    public partial class MarkdownToPDF : DemoControl
    {
        ...
        /// <summary>
        /// Converts the input html file to a pdf document
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void btnToPDF_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                if (this.textBox1.Text != String.Empty && fullPath != string.Empty)
                {
                    ...
                    {
                        MessageBox.Show("Browse an Markdown file to convert to PDF document", "Error", MessageBoxButton.OK, MessageBoxImage.Error);
                        return;
                    }
