...
namespace syncfusion.markdowndemos.wpf
{
    ...
    /// </summary>
    public partial class CreateMarkdown : DemoControl
    {
        #region Constructor
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            new[] { "Cat-like eyes","❌","✅" },
                ...
                try
                {
                    ...
                    if (MessageBox.Show("Do you want to view the generated Markdown document?", "Document has been created", MessageBoxButton.YesNo, MessageBoxImage.Information) == MessageBoxResult.Yes)
                    {
                        try
                        {
                            //Launching the Markdown file using the default Application.[Text Editor Or Free MarkdownViewer]
                        ...
                        {
                            MessageBox.Show("Text Editor or Markdown Viewer is not installed in this system");
                ...
                catch (Exception ex)
                {
                    if (ex is IOException)
                        MessageBox.Show("Please close the file (" + Directory.GetCurrentDirectory() + "\\CreateMarkdown.md" + ") then try generating the document.", "File is already open",
