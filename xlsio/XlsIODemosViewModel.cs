...
namespace syncfusion.xlsiodemos.wpf
{
    ...
    public class XlsIOProductDemos : ProductDemo
    {
        public XlsIOProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo()
            {
                SampleName = "Auto Fill & Fill Series",
                GroupName = "DATA MANAGEMENT",
                Description = "This sample demonstrates how to use the Auto Fill and Fill Series options with XlsIO.",
                DemoViewType = typeof(AutoFill)
            });
            ...
            this.Demos.Add(new DemoInfo()
            {
                ...
                Tag = Tag.New,
                GroupName = "CONVERSIONS",
                Description = "This sample demonstrates the conversion of Excel files to Markdown documents using Essential XlsIO.",
            ...
            this.Demos.Add(new DemoInfo()
            {
                ...
                Tag = Tag.New,
                GroupName = "CONVERSIONS",
                Description = "This sample demonstrates the conversion of Markdown documents to Excel file using Essential XlsIO.",
